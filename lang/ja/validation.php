...
return [
    ...
    'alpha_dash'             => ':attributeには、英数字（A-Z, a-z, 0-9）とハイフン、下線（-, _）が使用できます。',
    'alpha_num'              => ':attributeには、英数字（A-Z, a-z, 0-9）が使用できます。',
    'any_of'                 => ':attributeは、有効ではありません。',
    'array'                  => ':attributeには、配列を指定してください。',
    'ascii'                  => ':attributeには、英数字と記号のみ使用可能です。',
    'before'                 => ':attributeには、今日より前の日付を指定してください。',
    'before_or_equal'        => ':attributeには、今日以前の日付を指定してください。',
    'between'                => [
    ...
    'date_equals'            => ':attributeは今日と同じ日付を入力してください。',
    ...
    'missing'                => ':attributeを入力する必要はありません。',
    'missing_if'             => ':otherが:valueの場合、:attributeを入力する必要はありません。',
    'missing_unless'         => ':otherが:valueでない限り、:attributeを入力する必要はありません。',
    'missing_with'           => ':valuesが存在する場合、:attributeを入力する必要はありません。',
    'missing_with_all'       => ':valuesが存在する場合、:attributeを入力する必要はありません。',
    ...
    'present_with'           => ':valuesが存在する場合は、:attributeも存在する必要があります。',
    'present_with_all'       => ':valuesが存在する場合は、:attributeが存在する必要があります。',
