...
class SmartTaskParserService
{
     ...
     * =====================================================================================
     * 【メソッド名】 parse
     * 【概要】 自然言語タスク文字列の解析および構造化データ変換処理
     * =====================================================================================
     * 自然言語で入力されたタスク文字列から、優先度やカテゴリ、期日に関するショートカット
     * タグやキーワードを正規表現・文字列判定によって抽出し、クレンジングされたタイトルと
     * ともに構造化された連想配列として返却します。
     *
     * @param string $line 解析対象の生のタスク文字列
     * @return array<string, mixed> 構造化されたタスクデータの配列
     */
